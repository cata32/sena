...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2016 a las 01:29:48
...
CREATE TABLE `estudiante` (
  ...
  `EstMatricula` varchar(50) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `grado` (
  ...
  `GrDescripcion` varchar(160) CHARACTER SET latin1 NOT NULL,
  `GrNombre` varchar(11) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `materias` (
  ...
  `MatNombre` varchar(50) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pregunta` (
  ...
  `Pregunta` varchar(200) CHARACTER SET latin1 NOT NULL,
  `preCodigo` text CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `prueba` (
  ...
  `PrNombre` varchar(50) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `respuesta` (
  ...
  `ReCorrecta` varchar(20) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `tema` (
  ...
  `TeArea` varchar(50) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `usuario` (
  ...
  `UsApellido` varchar(50) CHARACTER SET latin1 NOT NULL,
  `UsGenero` varchar(10) CHARACTER SET latin1 NOT NULL,
  `UsTelefono` int(11) NOT NULL,
  `UsPassword` text CHARACTER SET latin1 NOT NULL,
