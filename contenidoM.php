...
<html lang="es">
        ...
        <div class="navbar-header">
            ...
            <span class="caret"></span>
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a class="text-center" href="principal.php">Mi cuenta</a></li>
                    <li><a class="text-center" href="progreso_materia.php">Mi progreso</a></li>
                    <li><a class="text-center" href="salir.php">Cerrar sesión</a></li>
                </ul>
            </div>
            </ul>
            <hr>
    ...
    <div class="row">
            <div class="col-md-12">
                <h2><p class="text-area text-center">Matemáticas</p></h2>
            </div>
    </div>
    <br>
    <div class="conteiner">
    ...
    <div class="container">
        ...
        <div class="row">
        <div class="col-xs-2">
        <button type="button" class="btn-actividad ">Actividad</button>
        </div>
        </div>
        <br>
        <div class="row">
        <div class="col-xs-2">
        <button type="button" class="btn-actividad ">Video</button>
        </div>
        </div>
        <br>
        <div class="row">
        <div class="col-xs-2">
        <button type="button" class="btn-actividad ">Prueba</button>
        </div>
        </div>
        <br>
        <div class="row">
        <div class="col-xs-2">
        <button type="button" class="btn-actividad ">Taller</button>
        </div>
        </div>
    </div>
